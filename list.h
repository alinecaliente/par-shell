...
void insert_new_terminal(list_t *list, int pid);

void kill_terminals(list_t *list);
...
/* search_exec_time - searches and returns execution time of element with pid 'pid' */
